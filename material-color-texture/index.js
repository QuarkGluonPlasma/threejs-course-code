/**
 * 导入 Three.js 库的所有模块，THREE 作为命名空间，包含 Three.js 提供的各种类和方法
 */
...
/**
 * 创建一个点光源对象
 * @param {number} 0xffffff - 光源颜色，使用十六进制表示白色
 * @param {number} 10000 - 光源强度
 */
